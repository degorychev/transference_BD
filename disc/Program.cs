...
namespace disc
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            comm.CommandText = "SELECT zaniatie.naimenovanie, zaniatie_original.naimenovanie AS 'orig' FROM zaniatie LEFT join zaniatie_original on zaniatie_original.ID = zaniatie.original_name";
            ...
            comm.CommandText = "SELECT ID FROM disciplines_original WHERE naimenovanie=?value1";
            ...
            comm.CommandText = "INSERT INTO disciplines (naimenovanie, original_name) VALUES (?value1, ?value2);";
            for (int i = 0; i < transes.Count; i++)
            {
