...
namespace gr_or
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            comm.CommandText = "SELECT `Naimenovanie` from groups_original GROUP BY `Naimenovanie`;";
            ...
            comm.CommandText = "INSERT INTO groups_original (Naimenovanie) VALUES (?value1);";
