...
namespace gr
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            comm.CommandText = "SELECT groups.Naimenovanie, groups_original.Naimenovanie AS 'orig' FROM groups LEFT join groups_original on groups_original.ID = groups.original_name";
            ...
            comm.CommandText = "SELECT ID FROM groups_original WHERE Naimenovanie=?value1";
            ...
            comm.CommandText = "INSERT INTO groups (Naimenovanie, original_name) VALUES (?value1, ?value2);";
            for (int i = 0; i < transes.Count; i++)
            {
